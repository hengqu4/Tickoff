<template>
  <div>
    ...
    <wux-white-space size="large" />
    <wux-cell-group>
      <wux-cell title="历史记录" is-link @click="viewHistory">
        <wux-icon
          wux-class="icon"
          slot="header"
      ...
      <wux-cell title="分享数据" is-link>
        <wux-icon wux-class="icon" slot="header" type="ios-ribbon" size="22" />
      </wux-cell>
    </wux-cell-group>
    <wux-white-space size="large" />
    <wux-cell-group>
      <wux-cell title="赞助" is-link data-url="" @click="onPreview($event)">
        <wux-icon wux-class="icon" slot="header" type="ios-create" size="22" />
      </wux-cell>
      <wux-cell title="帮助" is-link @click="viewHelp">
        <wux-icon wux-class="icon" slot="header" type="ios-paper" size="22" />
      </wux-cell>
      <wux-cell title="关于" is-link @click="clipboard">
        <wux-icon
          wux-class="icon"
          slot="header"
